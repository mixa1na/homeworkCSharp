...
namespace HospitalPatientManagement
{
    ...
    public class Program
    {
        ...
        public void Run()
        {
            ...
            Console.WriteLine("5 – Show patients by diagnosis");
            Console.WriteLine("6 – Show patients with stay length more than specified");
            Console.WriteLine("7 – Show patients younger than specified age");
